 ...
 * @author Wasif Islam
 */
public class SendEmailPasscode extends Thread {
    ...
    private org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(SendEmailPasscode.class);

    public SendEmailPasscode(String email, JLabel errorLabel, JTextArea errorTextArea, JButton sendButton, JButton doneButton, JButton cancelButton) {
        this.email = email;
    ...
    public void run() {
        if (InternetUnavailablityCheck.isInternetAvailable) {
            ...
            try {
                ...
                js_fields.setAction(AppConstants.TYPE_SEND_EMAIL_PASSCODE);
                ...
                for (int i = 1; i <= 10; i++) {
                    ...
                    if (MyfnfHashMaps.getInstance().getPacketGotResponseFromServer().get(pakId) == null) {
                        ...
                        if (feedBackFields.getSuccess()) {
                            ...
                            log.error(AppConstants.TYPE_SEND_EMAIL_PASSCODE + " response not in correct format==>" + feedBackFields.getMessage());
                ...
                log.error("Exception in SendEmailPasscode ==>" + ex.getMessage());
                this.doneButton.setEnabled(true);
                this.sendButton.setEnabled(true);
                this.cancelButton.setEnabled(true);
                this.errorLabel.setIcon(DesignClasses.return_image(GetImages.FAILED_MINI));
