 ...
 */
public class UpdateAddedSkillInfo extends Thread {
    ...
    private final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(UpdateAddedSkillInfo.class);
    private Map<Long, SkillInfoDTO> map;

    public UpdateAddedSkillInfo(CreateSkillSinglePanel instance) {
