 ...
 */
public class UpdateAddedEducationInfo extends Thread {

    private CreateEducationSinglePanel instance;
    private final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(UpdateAddedEducationInfo.class);
    private Map<Long, EducationInfoDTO> map;

    public UpdateAddedEducationInfo(CreateEducationSinglePanel instance) {
                                ...
                                if (e.getEducationId() == instance.educationInfoID) {
                                    ...
                                    if (instance.type_int == 0) {
                                        ...
                                        if (instance.attendedClgRadioButton.isSelected()) {
                                            ...
                                            e.setAttendedFor(2);
                                            if (!instance.degreeTextField.getText().trim().equals("")) {
                                                e.setDegree(instance.degreeTextField.getText());
                                            }
                                        }
