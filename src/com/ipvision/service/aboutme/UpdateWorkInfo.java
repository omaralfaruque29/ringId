...
import com.ipvision.view.myprofile.WorkSinglePanel;
 ...
 */
public class UpdateWorkInfo extends Thread {
    ...
    private final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(UpdateWorkInfo.class);
    private Map<Long, WorkInfoDTO> map;

    public UpdateWorkInfo(WorkSinglePanel instance) {
