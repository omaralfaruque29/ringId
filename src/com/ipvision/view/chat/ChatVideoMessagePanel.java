 ...
 * @author Shahadat
 */
public class ChatVideoMessagePanel extends JPanel {
    ...
    public ChatVideoMessagePanel(SingleChatPanel chatPanel) {
        ...
        this.downloadProgressBar.setToolTipText("Downloading Video Record");
        this.statusLabel.setText("Video Record");
    ...
    public boolean loadVideo() {
        ...
        try {
            ...
            if (file.exists()) {
                isLoaded = true;
                imageIcon = DesignClasses.return_image(GetImages.CHAT_DEFAULT_VIDEO);
                imageLabel.setToolTipText("Play Video Record");
            } else {
    ...
    MouseListener mouseListener = new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent e) {
            if (SwingUtilities.isRightMouseButton(e)) {
                ...
                try {
                    String videoName = ImageHelpers.getChatTransferFileName(messageDTO.getMessage());
                    File file = new File(ChatHelpers.CHAT_DIRECTORY.getChatFileDestinationFolder() + "/" + videoName);
                    if (file.exists()) {
    ...
    public DownloadProgressListener downloadProgressListener = new DownloadProgressListener() {
        ...
        public void onFailed(MessageBaseDTO mbdto) {
            ...
            statusLabel.setText("Video Record Downloading Failed");
        }
    };
