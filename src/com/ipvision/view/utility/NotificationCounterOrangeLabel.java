...
public class NotificationCounterOrangeLabel extends JLabel{
    ...
    public NotificationCounterOrangeLabel(){
        setOpaque(false);
    ...
    public void paintComponent(Graphics g) {
        if(getWidth() >= SIZE_20){
            icon = DesignClasses.return_image(GetImages.COUNTER_ORANGE_20);
            g.drawImage(icon.getImage(), 0, 0, null);
        } if(getWidth() >= SIZE_17){
            icon = DesignClasses.return_image(GetImages.COUNTER_ORANGE_17);
            g.drawImage(icon.getImage(), 0, 0, null);
        } else if(getWidth() >= SIZE_13){
            icon = DesignClasses.return_image(GetImages.COUNTER_ORANGE_13);
            g.drawImage(icon.getImage(), 0, 0, null);
        } else {
