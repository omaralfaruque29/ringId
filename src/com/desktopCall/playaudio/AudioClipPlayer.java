...
public class AudioClipPlayer implements LineListener {
    ...
    private org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(AudioClipPlayer.class);
    /**
     * The sound clip
     */
    Clip clip = null;
    ...
    /**
     * Creates a new AudioClipPlayer. param@ filename the name of a valid audio
     * file, param@ listener the AudioClipPlayer listener.
     */
    public AudioClipPlayer(String filename, AudioClipPlayerListener listener) {
        try {  //FileInputStream inputstream=new FileInputStream(new File(filename));
           ...
           // e.printStackTrace();
        log.error("Error in AudioClipPlayer class" + e.getMessage());
        }
    }

    /**
     * Creates a new AudioClipPlayer. param@ file a valid audio file, param@
     * listener the AudioClipPlayer listener.
     */
    public AudioClipPlayer(File file, AudioClipPlayerListener listener) {
        try {  //AudioInputStream audio_inputstream=AudioSystem.getAudioInputStream(new FileInputStream(file));
    ...
    /**
     * Creates a new AudioClipPlayer. param@ audio_inputstream an
     * AudioInputStream, param@ listener the AudioClipPlayer listener.
     */
    ...
    /**
     * Creates a new AudioClipPlayer. param@ inputstream an InputStream pointing
     * to valid audio file data, param@ listener the AudioClipPlayer listener.
     */
    ...
    /**
     * Sets the volume gain, between -1 (min) and +1 (max). Value 0 corrisponds
     * to the original volume level.
     */
    public AudioClipPlayer setVolumeGain(float volume) {  //System.err.println("DEBUG: set clip volume gain (linear): "+volume);        
    ...
    public AudioClipPlayer goTo(long millisec) {
        if (clip != null) {
            clip.setMicrosecondPosition(millisec);
        }
        return this;
    }
    ...
    public void update(LineEvent event) {
        if (event.getType().equals(LineEvent.Type.STOP)) {  //clip.close();
            if (listener != null) {
                listener.onAudioClipStopped(this);
            }
        }
    }
